...
// TODO: consider whether we want to add field, hash and version info to the
// tags
pub enum LanguageField {
    Pallas = 0b0000_0000_0000_0000,
    Vesta,
    BLS12_381,
}

pub enum LangHashFunction {
    Poseidon = 0b000_0000_0000_000,
}
...
pub trait LurkField: ff::PrimeField {
    const LURK_MULTICODEC: u64 = 0xc0de;
